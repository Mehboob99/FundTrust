  ...
  return (
    <div style={{ fontFamily: 'DM Sans,sans-serif', background: '#fff' }}>
      ...
      <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: "url('/api/uploads/hero.png')", backgroundSize: 'cover', backgroundPosition: 'center 30%', animation: 'bgPan 18s ease-in-out infinite alternate' }} />
